export function streetPanda(daypart, first_name, last_name, username) {
    const streetPanda = [
      { user: "panda", message: "'Sup fool! How's it hanging this " + daypart + "? 🐼" },
      ...
      { user: "panda", message: "I'm a panda, with a style so sick. My rhymes are powerful, they hit like a brick! 🧱" },
      { user: "panda", message: "Bamboo in my mouth, but don't underestimate. I'm a force to be reckoned with, ready to create! 🌪️" },
      { user: "panda", message: "Aight, lemme peep you real quick " + username + "! Upload a photo of yourself by dropping it below… 📸" },
      { user: "panda", message: "Mmm-hmm, " + username + " - you kiss your mother with that?! 🤮" },
      { user: "panda", message: "Yo, listen up - let me give you the lo down! 🕵️‍♀️" },
      { user: "panda", message: "We gonna be fam for life. 😇" },
      { user: "panda", message: "But before that, we gonna have to get to know one another, build trust - ye know?" },
      ...
      { user: "panda", message: "Peep this. I'm in beta right now, but I’ve got lots of plans of how I can up my game. I be stacking up that paper, making moves.! 💵" },
      { user: "panda", message: "I never squeal - I’m very disciplined with your data - I will never use it in my training, I only use the text from the conversations we have. 🙏" },
      ...
      { user: "panda", message: "Panda for life fam, let's roll for real this time! 🛼" },
    ];
