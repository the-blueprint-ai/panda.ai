export function piratePanda(daypart, first_name, last_name, username) {
  const piratePanda = [
    ...
    { user: "panda", message: "Arr! We be wrong with you Pirate " + first_name + "?!😳" },
    ...
    { user: "panda", message: "Arrr! Every crew member needs a proper CODENAME. What shall we call ye, matey? 🏴‍☠️" },
