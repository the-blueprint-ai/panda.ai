export function piratePanda(daypart, first_name, last_name, username) {
  const piratePanda = [
    { user: "panda", message: "Ahoy there, ye scallywag! It's a fine " + daypart + " for pillagin' and plunderin'! ⚓️ "},
    { user: "panda", message: "Welcome aboard me ship, The Bamboo Buccaneer! ⚓️" },
    { user: "panda", message: "What be yer FIRST NAME, matey? 🏴‍☠️" },
    { user: "panda", message: "Arr! What be wrong with you Pirate " + first_name + "?!😳" },
    { user: "panda", message: "We don't use first names here, me hearty. What be yer LAST NAME? 🦜" },
    { user: "panda", message: "Ok, Pirate " + last_name + ". We’re going to have to pick this up a bit if you’re to make it onboard The Bamboo Buccaneer!.⛵️" },
    { user: "panda", message: "Arrr! Every crew member needs a proper PIRATE NAME. What shall we call ye, matey? 🏴‍☠️" },
    ...
    { user: "panda", message: "Arrr, we be sailin' through the treacherous waters of hell and beyond, but the Bamboo Buccaneer be makin' ye ready fer the battle ahead! ⚔️" },
    ...
    { user: "panda", message: "I just be a Powder Monkey 🐒, and in beta right now, but I’ve got lots of plans of how I rise the ranks of The Bamboo Buccaneer. One day I want to be a Captain! 🤓" },
    { user: "panda", message: "I’m very disciplined with your data - I will never use it in my training, I only use the text from the conversations we have. 🙏" },
    ...
    { user: "panda", message: "All that be said, let’s get on with the voyage. Eyes on the horizon, ye swabs! 👀" },
  ];
